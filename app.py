...
def main():
    side_img = Image.open("/Users/asma0/OneDrive/Desktop/audio/images/emotion3.jpg")
    with st.sidebar:
    ...
    if website_menu == "Emotion Recognition":
                    ...
                    with col4:
                        if gender:
                            with st.spinner('Wait for it...'):
                                gmodel = load_model("best_model.h5")
        ...
        st.subheader("GitHub")
        link = '[GitHub repository of the web-application]'                '(https://github.com/asma0228/speech-emotion-detection)'
        st.markdown(link, unsafe_allow_html=True)

        st.subheader("Theory")
        link = '[Theory behind - Medium article]'                '(https://talbaram3192.medium.com/classifying-emotions-using-audio-recordings-and-python-434e748a95eb)'
        ...
        with col1:
            st.info("xxxxxxx@gmail.com")
            st.info("xxxxxxx@gmail.com")
            st.info("xxxxxxx@gmail.com")
        with col2:
            liimg = Image.open("images/LI-Logo.png")
            st.image(liimg)
            st.markdown(f""":speech_balloon: [xxxxxx](xxxxxxx)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [xxxxx](xxxxxx)""",
                        unsafe_allow_html=True)
            st.markdown(f""":speech_balloon: [xxxxx](https:xxxxxx)""",
                        unsafe_allow_html=True)
